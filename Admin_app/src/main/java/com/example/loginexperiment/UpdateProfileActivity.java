...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    private EditText editTextUpdateFirstName, editTextUpdateLastName, editTextUpdateDOB, editTextUpdateMobile, editTextUpdateAddress, editText_update_description;
    private String textFirstname, textLastname, textDOB, textMobile, textAddress, textGender, textdescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_update_description = findViewById(R.id.editText_update_description);
        ...
        buttonUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UpdateProfileActivity.this, EditEmailActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void updateProfile(FirebaseUser firebaseUser) {
        ...
        if (TextUtils.isEmpty(editTextUpdateFirstName.getText())){
            ...
            textGender = dropdownGender.getSelectedItem().toString();
            textdescription = editText_update_description.getText().toString();

            // enter user data ino the firebase
            ReadWriteUserDetails writeUserDetails = new ReadWriteUserDetails(textFirstname, textLastname, textMobile, textAddress, accessUser, textDOB, textGender, textdescription);
            ...
            referenceProfile.child(userID).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(UpdateProfileActivity.this, "Error updating...", Toast.LENGTH_LONG).show();
                }
            });

            if(accessUser.equals("superadmin")){
                referenceProfile = FirebaseDatabase.getInstance().getReference().child("Main");
        ...
        referenceProfile.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readWriteUserDetails != null) {
                    ...
                    accessUser = readWriteUserDetails.UserAccess;
                    textdescription = readWriteUserDetails.textdescription;
                    ...
                    editText_update_description.setText(textdescription);
